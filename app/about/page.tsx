...
export default function About() {
  return (
    <section className="w-full max-w-3xl mx-auto">
      <h1 className="text-4xl font-bold text-zinc-900 dark:text-zinc-50 mb-8">About</h1>
      <div className="bg-white dark:bg-neutral-800 rounded-2xl p-8 border border-zinc-200 dark:border-neutral-700 shadow-lg">
        ...
        <Link 
          ...
          className="mt-8 inline-flex items-center gap-2 px-6 py-3 rounded-lg border-2 border-zinc-300 dark:border-neutral-600 font-medium hover:bg-zinc-100 dark:hover:bg-neutral-700 transition-all duration-200 hover:shadow-md"
        >
